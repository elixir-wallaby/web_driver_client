defmodule WebDriverClient.W3CWireProtocolClient.Commands.FetchElementRect do
  @moduledoc false
  ...
  def send_request(%Session{id: session_id, config: %Config{} = config}, %Element{id: element_id}) do
    client = TeslaClientBuilder.build_simple(config)
    url = "/session/#{session_id}/element/#{element_id}/rect"

defmodule WebDriverClient.W3CWireProtocolClient.Commands.FetchElementAttribute do
  @moduledoc false
  ...
  @spec send_request(Session.t(), Element.t(), W3CWireProtocolClient.attribute_name()) ::
